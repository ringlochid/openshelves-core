...
class TestAuthorRollback:
    ...
    async def test_rollback_permission_owner_can_rollback(self, async_client: AsyncClient, test_db):
    ...
    async def test_rollback_permission_wiki_editor_can_rollback_approved(self, async_client: AsyncClient, test_db):
    ...
    async def test_rollback_permission_denied_non_owner_pending(self, async_client: AsyncClient, test_db):
    ...
    async def test_rollback_creates_new_version(self, async_client: AsyncClient, test_db):
